...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li><a href="../find.php">Find Medicine</a></li>
			<li class="active">Sore Throat</li>
		</ol>
<h2>Medicine for Sore Throat</h2>
	<br>
	<br>
	...
	<div class="row">
                  ...
                  <?php
                     ...
                     $query = $conn->query("select * from medicine where disease='sore throat'");
                ...
                <div class="col-md-2 col-sm-3 text-center">
                    ...
                    <img class="photo" src="<?php echo $row['location']; ?>" width="200" height="190"><br>

                    <h4><span class="label label-success"><a href="<?php echo $row['link']; ?>" > <?php echo $name; ?></a></span></h4>
